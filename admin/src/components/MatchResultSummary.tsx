...
import { computeMatchResult } from "@/lib/api/types";
...
export function MatchResultSummary({ match }: { match: Match }) {
  ...
  return (
    ...
    >
      <div className="bg-[var(--color-pitch)] px-4 py-3 text-white sm:px-5">
          ...
          >
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate font-semibold text-[var(--color-pitch-deep)]">
                  {line.team.name}
                </p>
            ...
            <div className="text-right">
              <p
                className="text-2xl font-semibold tabular-nums text-[var(--color-pitch-deep)]"
