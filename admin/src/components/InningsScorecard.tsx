import type { Innings, InningsScorecardData, PlayerBrief } from "@/lib/api/types";
...
export function InningsScorecard({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2 bg-[var(--color-pitch)] px-4 py-3 text-white sm:px-5">
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[28rem] border-collapse text-sm">
          <thead>
            <tr className="border-b border-[var(--color-line)] bg-[var(--color-cream)] text-left text-xs uppercase tracking-wide text-[var(--color-muted)]">
          ...
          <tbody>
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-2.5 sm:px-5">
                      <p
                        className={cn(
                          "font-medium text-[var(--color-pitch-deep)]",
            ...
            <tr className="border-b border-[var(--color-line)] bg-[var(--color-cream)]/60">
          ...
          <tbody>
            {scorecard.bowlers.length === 0 ? (
              ...
              scorecard.bowlers.map((row) => (
                ...
                >
                  <td className="px-4 py-2.5 font-medium text-[var(--color-pitch-deep)] sm:px-5">
                    {row.player.name}
                  </td>
