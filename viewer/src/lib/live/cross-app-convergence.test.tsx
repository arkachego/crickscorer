/**
 * Viewer-side mirror of Admin cross-application convergence projections.
 */
...
describe("Admin/Viewer cross-application convergence", () => {
  ...
  it("Viewer cache converges on the same authoritative snapshot fields as Admin", () => {
    const viewer = new QueryClient();
    const snap = authoritativeSnapshot(3);
    expect(applyMatchLiveSnapshot(viewer, snap)).toBe(true);
